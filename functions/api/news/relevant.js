// Cloudflare Pages Function: /api/news/relevant
// Aggregates query-relevant stories from Marketaux + Finnhub
...
export async function onRequestGet(context) {
  try {
    ...
    return jsonResp(200, { ok: false, items: [], error: err && err.message ? err.message : 'Failed to load relevant news' });
  }
}
